...
//
//     const fetchTrainers = async (pageNumber) => {
//         try {
//             const response = await getAllFavoriteTrainers(parentId, pageNumber - 1, PAGE_SIZE);
...
//                         {trainers.length === 0 ? (
//                             <TableRow>
//                                 <TableCell colSpan={5}>Nu ai traineri favoriți.</TableCell>
//                             </TableRow>
//                         ) : (
                        ...
                        {trainers.length === 0 ? (
                            ...
                            trainers.map((trainer) => (
                                <TableRow key={trainer.id}>
                                    ...
                                    <TableCell>{trainer.gender === 'MALE' ? 'Masculin' : 'Feminin'}</TableCell>
                                    <TableCell>{new Date(trainer.birthDate).toLocaleDateString("ro-RO")}</TableCell>
                                    <TableCell><Button variant="notification" onClick={handleRemoveFavoriteTrainer()}>Dezabonează-te</Button></TableCell>
                                </TableRow>
                            ))
                        )}
                    </TableBody>
